...
return (
          ...
          >
            <div className={`${classes.noisegradient} dark:mix-blend-screen opacity-0 group-hover:opacity-100`} style={{ filter: `hue-rotate(${props.shift}deg)` }}></div>
    ...
    <div className="bg-white dark:bg-[#0a0a0a] text-black dark:text-white rounded-xl overflow-clip relative">
      <div className="z-10">
        <div className="relative px-7 pt-14 pb-12 border-b border-black/10 dark:border-white/[0.07]">
          ...
          <Link className="px-2 mt-6 py-1.5 bg-[#d95718] hover:bg-[#e15c1b] rounded-sm text-xs flex gap-2 items-center" role="button" href="/docs/tristero">
            Get Started

            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">{/* Icon from Google Material Icons by Material Design Authors - https://github.com/material-icons/material-icons/blob/master/LICENSE */}<path fill="currentColor" d="M5.7 6.71a.996.996 0 0 0 0 1.41L9.58 12L5.7 15.88a.996.996 0 1 0 1.41 1.41l4.59-4.59a.996.996 0 0 0 0-1.41L7.12 6.71c-.39-.39-1.03-.39-1.42 0" /><path fill="currentColor" d="M12.29 6.71a.996.996 0 0 0 0 1.41L16.17 12l-3.88 3.88a.996.996 0 1 0 1.41 1.41l4.59-4.59a.996.996 0 0 0 0-1.41L13.7 6.7c-.38-.38-1.02-.38-1.41.01" /></svg>
          </Link>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3">
          <Card href="/docs/tristero/python-sdk" number="01" title="Python SDK"  description="Trading SDK documentation and reference" shift={0} />
          <Card href="/docs/tristero" number="02" title="Tristero API"  description="Core API reference and endpoint specs" shift={200} />
          <Card href="/docs/feather" number="03" title="Feather API"  description="Cross-chain swap relay integration" shift={300} />
        </div>
      </div>
    </div>
  );
