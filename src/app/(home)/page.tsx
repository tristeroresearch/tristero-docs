    ...
    <div className="bg-white dark:bg-[#0a0a0a] text-black dark:text-white rounded-xl overflow-clip relative">
      ...
      />
          ...
          <p className="font-mono text-sm text-black/40 dark:text-white/40 leading-relaxed max-w-[480px]">
            Integration references, API specifications, and SDK documentation for the Tristero trading platform.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3">
          <Link href="/docs/tristero/python-sdk" className="group p-7 border-r border-b border-black/10 dark:border-white/[0.07] hover:bg-black/[0.03] dark:hover:bg-white/[0.03] transition-colors relative overflow-hidden block">
            <div className="font-mono text-[11px] text-black/20 dark:text-white/[0.18] mb-5">01</div>
          ...
          <Link href="/docs/tristero" className="group p-7 border-r border-b border-black/10 dark:border-white/[0.07] hover:bg-black/[0.03] dark:hover:bg-white/[0.03] transition-colors relative overflow-hidden block">
            <div className="font-mono text-[11px] text-black/20 dark:text-white/[0.18] mb-5">02</div>
          ...
          <Link href="/docs/feather" className="group p-7 border-b border-black/10 dark:border-white/[0.07] hover:bg-black/[0.03] dark:hover:bg-white/[0.03] transition-colors relative overflow-hidden block">
            <div className="font-mono text-[11px] text-black/20 dark:text-white/[0.18] mb-5">03</div>
            <div className="w-[3px] h-5 bg-black/12 dark:bg-white/[0.12] mb-5"></div>
            <h3 className="font-syne text-[17px] font-semibold text-black dark:text-white mb-2 tracking-[-0.01em]">
              Feather API
            </h3>
            <p className="font-mono text-[13px] text-black/40 dark:text-white/[0.38] leading-relaxed">
              Cross-chain swap relay integration
            </p>
            <div className="absolute bottom-6 right-6 text-sm text-black/20 dark:text-white/[0.18] group-hover:text-[#E07830] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all">
              ↗
            </div>
