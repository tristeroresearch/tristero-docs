  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center px-4 relative">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle 800px at 0px 0px, rgba(249, 121, 14, 0.15) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col gap-4 w-full max-w-xl">
          <Link 
            ...
            className="group relative flex flex-row items-center p-4 rounded-xl border-2 border-border bg-card hover:bg-[#F9790E] hover:border-[#F9790E] transition-all duration-300 hover:shadow-lg hover:shadow-[#F9790E]/20 overflow-hidden"
          >
            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#F9790E]/10 flex items-center justify-center group-hover:scale-110 group-hover:bg-white/20 transition-transform">
